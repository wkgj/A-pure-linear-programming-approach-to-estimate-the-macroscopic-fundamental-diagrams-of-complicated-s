...
<sc version="201801" id="5" name="60" frequency="1" steps="0" defaultIntergreenMatrix="0" interstagesUsingMinDurations="true" checkSum="2981550247">
  <signaldisplays>
  ...
  <sgs>
    <sg id="1" name="40_S" defaultSignalSequence="3">
      <defaultDurations>
    ...
    <sg id="2" name="20_S" defaultSignalSequence="3">
      <defaultDurations>
        <defaultDuration display="1" duration="1000" />
        <defaultDuration display="2" duration="1000" />
        <defaultDuration display="3" duration="5000" />
